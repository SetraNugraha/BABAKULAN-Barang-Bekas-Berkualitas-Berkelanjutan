            ...
            <div class="container-fluid">
                ...
                <form action="" method="post" enctype="multipart/form-data" style="width: 50%; margin-left: 40px; min-height:900px">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nama_brg" name="nama_brg" placeholder="Nama Barang ..." required autocomplete="off">
                    </div>

                    <div class="mb-3">
                        <label for="tipe_brg" class="form-label">Tipe Barang</label>
                        <input type="text" class="form-control" id="tipe_brg" name="tipe_brg" placeholder="Tipe Barang ..." required autocomplete="off">
                    </div>

                    <div class="mb-3">
                        <label for="jenis_brg" class="form-label">Jenis Barang</label>
                        <input type="text" class="form-control" id="jenis_brg" name="jenis_brg" placeholder="Jenis Barang ..." required autocomplete="off">
                    </div>
