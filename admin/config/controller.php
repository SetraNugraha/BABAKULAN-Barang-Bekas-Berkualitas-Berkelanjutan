...
//fungsi menambahkan data ACARA
function create_acara($post)
{

    // panggil koneksi database
    global $db;

    $nama_acara = $post['nama_acara'];
    $tgl_acara = $post['tgl_acara'];
    $tempat_acara = $post['tempat_acara'];
    $gambar_acara = upload_file_acara();
    ...
    //query tambah data
    $query = "INSERT INTO acara VALUES
    (null,
    '$nama_acara',
    '$tgl_acara',
    '$tempat_acara',
...
// fungsi mengupload file 
function upload_file_acara()
{
    $namaFile   = $_FILES['gambar_acara']['name'];
    $ukuranFile = $_FILES['gambar_acara']['size'];
    $error      = $_FILES['gambar_acara']['error'];
    ...
    //pindahkan ke folder local 
    move_uploaded_file($tmpName, 'assets/img/gambar_acara/' . $namaFileBaru);

    return $namaFileBaru;
}

// fungsi mengedit data Acara

function update_acara($post)
{
    global $db;
    ...
    //cek upload gambar baru atau tidak
    if ($_FILES['gambar_acara']['error'] == 4) {
        $gambar_acara = $gambarLama;
    } else {
        //ambil gambar sesuai gambar yang dipilih
        $gambar_acara = select("SELECT * FROM acara WHERE id_acara = $id")[0];
        $gambar_img = $gambar_acara["gambar_acara"];
        ...
        unlink("assets/img/gambar_acara/" . $gambar_img);
    }
...
function delete_acara($id)
{
    ...
    //ambil gambar sesuai gambar yang dipilih
    $gambar_acara = select("SELECT * FROM acara WHERE id_acara = $id")[0];
    unlink("assets/img/gambar_acara/" . $gambar_acara['gambar_acara']);
